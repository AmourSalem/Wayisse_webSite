      ...
      <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6'>
        ...
        <div className='space-y-4'>
          ...
          <div className='flex items-center space-x-5'>
            <Link href="#" >
              <svg xmlns="http://www.w3.org/2000/svg" className='hover:text-primary'  width="32" height="32" viewBox="0 0 24 24"><g fill="none"><g clipPath="url(#akarIconsFacebookFill0)"><path fill="currentColor" fillRule="evenodd" d="M0 12.067C0 18.034 4.333 22.994 10 24v-8.667H7V12h3V9.333c0-3 1.933-4.666 4.667-4.666c.866 0 1.8.133 2.666.266V8H15.8c-1.467 0-1.8.733-1.8 1.667V12h3.2l-.533 3.333H14V24c5.667-1.006 10-5.966 10-11.933C24 5.43 18.6 0 12 0S0 5.43 0 12.067" clipRule="evenodd"/></g><defs><clipPath id="akarIconsFacebookFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g></svg>
            </Link>
            <Link href="#">
            ...
            <Link href="#">
              <svg xmlns="http://www.w3.org/2000/svg" className='hover:text-primary' width="37" height="37" viewBox="0 0 22 22"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M21 8v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5"/><path d="M10 12a3 3 0 1 0 3 3V6c.333 1 1.6 3 4 3"/></g></svg>
            </Link>
            <Link href="#">
